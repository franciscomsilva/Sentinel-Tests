...
class StatisticsOKMonthlyStepDefs {
	@Given("I choose monthly on the statistics tab")
	def i_choose_monthly_on_the_statistics_tab() {
		...
		Mobile.tap(findTestObject('AT12 - Statistics Objects/android.widget.CheckedTextView0 - Month'), 0)
	}
}