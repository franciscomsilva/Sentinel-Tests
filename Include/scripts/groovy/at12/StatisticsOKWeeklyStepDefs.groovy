...
class StatisticsOKWeeklyStepDefs {
	@Given("I choose weekly on the statistics tab")
	def i_choose_weekly_on_the_statistics_tab() {
		...
		Mobile.tap(findTestObject('AT12 - Statistics Objects/android.widget.CheckedTextView0 - Week'), 0)
	}
}