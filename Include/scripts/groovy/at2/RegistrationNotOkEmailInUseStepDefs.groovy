...
class RegistrationNotOkEmailInUseStepDefs {
	/**
	 * The step definitions below match with Katalon sample Gherkin steps
	 */
	@When("I provide email that is already in use by an account")
	def i_provide_email_that_is_already_in_use_by_an_account() {
		Mobile.verifyElementExist(findTestObject('Registration Objects/android.widget.EditText0 - E-mail'), 0)
		
		Mobile.setText(findTestObject('Registration Objects/android.widget.EditText0 - E-mail'), 'email1@gmail.com', 0)
		...
		Mobile.verifyElementExist(findTestObject('Registration Objects/android.widget.TextView0 - The email addressed is already asssociated with an account'),
			0)
	}
}