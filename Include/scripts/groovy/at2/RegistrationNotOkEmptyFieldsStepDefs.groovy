...
class RegistrationNotOkEmptyFieldsStepDefs {
	 ...
	 */
	@When("I provide empty fields one by one")
	def i_provide_empty_fields_one_by_one() {
		...
		Mobile.verifyElementExist(findTestObject('Registration Objects/android.widget.TextView0 - Email field is mandatory'), 0)
		
		Mobile.setText(findTestObject('Registration Objects/android.widget.EditText0 - E-mail'), 'email@gmail.com', 0)
		
		Mobile.tap(findTestObject('Registration Objects/android.widget.Button0 - CREATE ACCOUNT'), 0)
		
		Mobile.verifyElementExist(findTestObject('Registration Objects/android.widget.TextView0 - Password field is mandatory'),
			0)
		...
		Mobile.verifyElementExist(findTestObject('Registration Objects/android.widget.TextView0 - Password confirmation field is mandatory'),
			0)
	}
}