...
class FavoritesRemoveOKDashboardStepDefs {
	@When("I click in the star next to the room I want to unfavorite")
	def i_click_in_the_star_next_to_the_room_I_want_to_unfavorite() {
