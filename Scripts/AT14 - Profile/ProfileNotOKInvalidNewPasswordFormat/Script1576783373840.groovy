...
Mobile.setText(findTestObject('AT14 Objects/New Password TextBox'), 'invformat', 0)

Mobile.setText(findTestObject('AT14 Objects/New Password Confirmation TextBox'), 'invformat', 0)

Mobile.tap(findTestObject('AT14 Objects/SAVE Profile Changes'), 0)

Mobile.verifyElementExist(findTestObject('AT14 Objects/Erro - Password must have at least have 8 digits 1 number and 1 special character'), 
    0)
